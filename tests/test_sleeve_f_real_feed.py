...
from evidence.sleeve_f_real import build_front_month_replay_trades, evaluate_replay_trades, run_sleeve_f_real_feed_evidence
from evidence.futures_costs import COST_SCENARIOS_BPS, futures_round_trip_cost_bps
from evidence.sleeves import futures_promotion_gates_from_metrics
